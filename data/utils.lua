...
Version2 = '۲.۲'
-----------------
Check1 = 'No update available'
Check2 = 'هیچ بروز رسانی موجود نیست'
Check3 = 'yes update available'
Check4 = 'بروز رسانی موجود است'
-----------------
TelegramBOT = ' nightly (171011)'
TelegramBOT2 = ' nightly (171011)'
-----------------
Getbackup = 'انجام شد بزودی نصب و راه اندازی خواهد شد'
Getbackup2 = 'It will be completed soon'
LTIMREN = ' TEHRAN '
LTIMRFA = ' تهران '
Reboot = 'The server was successfully rebooted and loaded now.'
Reboot2 = 'سرور با موفقیت ریبوت شد و هم اکنون بار گذاری انجام شد.'
------------------
---------------------Unregistered alert-----------------------------------
